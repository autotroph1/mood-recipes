...
const { getImageForRecipe } = require('./recipe-images');
...
app.get('/api/recipes/:mood', (req, res) => {
  ...
  const { url, credit } = getImageForRecipe(randomRecipe.name);
  randomRecipe.image = url;
  randomRecipe.imageCredit = credit;
